  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested recipe" do
        ...
        recipe.reload
        expect(recipe.description).to eq("a new description")
      end
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the recipe" do
        skip("No way to provide invalid parameters from a request")
        recipe = Recipe.create! valid_attributes

        put :update, params: {id: recipe.to_param, recipe: {name: nil}}, session: valid_session
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
